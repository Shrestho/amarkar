...
if(isset($_POST["Submit"])){
  ...
  if(empty($name)){
    ...
    $Query="UPDATE admin_panel SET holdingnumber='$holdingnumber', name='$name',phone='$phone',
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Edit Tax Information</title>
...
while ($DataRows=mysqli_fetch_array($ExecuteQuery)) {
  $holdingnumbertoupdate=$DataRows["holdingnumber"];
...
<form class="" action="EditPost.php?Edit=<?php echo $searchQueryParameter; ?>" method="post" enctype="multipart/form-data">
  <fieldset>
    ...
    <input   class="form-control" type="text" name="holdingnumber" id="holdingnumber" value="<?php echo $holdingnumbertoupdate; ?>" placeholder="holdingnumber">
  </div> <br>
    <div class="form-group">
